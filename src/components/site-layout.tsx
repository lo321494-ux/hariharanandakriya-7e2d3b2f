...
function Footer(){return <footer className="site-footer"><div className="footer-radiance"/><div className="section-x footer-grid">
  ...
  <div><p className="footer-label">SECCIONES</p><ul className="footer-links">{([["Antecedentes","/antecedentes"],["Documentos","/documentos"],["Libros","/libros"],["Kriya Yoga","/kriya-yoga"],["Noticias","/noticias"],["Contacto","/contacto"]] as const).map(([l,t])=><li key={t}><Link to={t}>{l}</Link></li>)}</ul></div>
